...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">EDUCATOR</a>
			<button
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						Cimagian are able to use this site free off cost,This is made onlt for 
                                                cimage<a href="http://startbootstrap.com">Cimage</a> .
					</p>
				</div>
			</div>
		</div>
